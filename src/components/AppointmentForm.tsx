...
interface AppointmentFormProps {
  onCancel: () => void;
  // ✅ 1. Update onSave to include the optional end date for the series
...
export default function AppointmentForm({
  ...
  // ✅ 2. Add state for the recurrence end date
  ...
  // ✅ 3. Update handleSubmit to include the end date logic
  ...
  return (
    <div className="bg-card p-6 rounded-lg shadow-lg border">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* ✅ 4. Updated Recurrence Section with End Date field */}
        ...
        {(formState.eventType === 'job' || formState.eventType === 'personal') && (
            <>
                <div className="md:col-span-2">
                  ...
                  <select name="locationType" value={locationType} onChange={(e) => setLocationType(e.target.value as any)} className="w-full mt-1 p-2 border rounded-md bg-background">
