...
function MailboxPageContentInternal({ userId }: { userId: string }) {
    ...
    const [isSendingMessage, setIsSendingMessage] = useState(false); // ✅ DEDICATED STATE FOR SEND BUTTON
    ...
    const handleScheduleEducation = async () => {
        ...
        const appointmentData: Partial<Appointment> = { subject: selectedMessage.subject, date: educationFormData.date, time: educationFormData.time, eventType: 'education', status: 'scheduled', notes: `Event scheduled from email:\nFrom: ${selectedMessage.senderName}\nSubject: ${selectedMessage.subject}\n\n${selectedMessage.body}` };
