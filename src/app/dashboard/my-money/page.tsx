...
// ✅ FIX 1: Added 'getAppointments' and 'updateUserProfile'
import { getInvoices, getExpenses, getClients, getUserProfile, updateUserProfile, getAppointments } from '@/utils/firestoreService';
...
export default function MyMoneyPage() {
    ...
    const [activeTab, setActiveTab] = useState<'invoices' | 'expenses' | 'overview'>('overview');
    ...
    const stats = useMemo(() => {
        ...
        const expensesValue = Number(ytdExpenses) || 0;
