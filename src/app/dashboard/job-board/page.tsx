// src/app/dashboard/job-board/page.tsx
"use client";

import { useState, useEffect, useMemo } from 'react';
import type { JobPosting, UserProfile } from '@/types/app-interfaces';
import { getJobPostings, getUserProfile } from '@/utils/firestoreService';
import Link from 'next/link';
import { PlusCircle, Search, Briefcase, MapPin, Tag } from 'lucide-react';
import { Switch } from "@/components/ui/switch"; // ✅ 1. Import the Switch component
...
const JobPostCard = ({ post }: { post: JobPosting }) => {
    ...
    return (
        <div className="bg-card p-6 rounded-lg border hover:border-primary hover:shadow-lg transition-all flex flex-col h-full">
...
export default function JobBoardPage() {
    ...
    // ✅ 2. Add state for our new toggle
            ...
            <div className="mb-6 p-4 bg-card border rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    ...
                    <div>
                     ...
                     {/* ✅ 4. Add the toggle switch to the UI */}
